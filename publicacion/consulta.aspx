<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consulta.aspx.cs" Inherits="queja.consulta" %>
                                                    ...
                                                    <div class="form-group">
                                                        <div id="datosqueja" runat="server">
                                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                <center>
                                                                    <a><asp:Image ID="img1" runat="server" CssClass="img-thumbnail img-responsive" style="width: 250px; height: 150px;"/></a>
                                                                    <a><asp:Image ID="img2" runat="server" CssClass="img-thumbnail img-responsive" style="width: 250px; height: 150px;"/></a>
                                                                    <a><asp:Image ID="img3" runat="server" CssClass="img-thumbnail img-responsive" style="width: 250px; height: 150px;"/></a>
                                                                </center>
                                                            </div>
                                                        </div>
