<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="quejas_fumigacion.aspx.cs" Inherits="queja.quejas_fumigacion" %>
            ...
            <div class="col-md-12 col-md-offset-0">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <center><h1><strong class="">Quejas Fumigacion</strong></h1></center>
                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group form-inline">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <label for="cmbInsecto" class="col-sm-1 control-label hidden-sm hidden-xs">Insecto</label>
                                            <asp:DropDownList ID="cmbInsecto" runat="server" width="200px"
                                                CssClass="form-control btn btn-primary col-xs-12 col-lg-4 col-sm-4" 
                                                AutoPostBack="true" 
                                                onselectedindexchanged="cmbInsecto_SelectedIndexChanged" >
                                            </asp:DropDownList>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="gvwQuejas" runat="server" AutoGenerateColumns="False" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Hold" 
                                                            HeaderStyle-CssClass="visible-lg hidden-sm hidden-xs hidden-md" 
                                                            ItemStyle-CssClass="visible-lg hidden-sm hidden-xs hidden-md" 
                                                            DataField="que_hold">
                                                        <HeaderStyle CssClass="visible-lg hidden-sm hidden-xs hidden-md" Width="20"/>
                                                        ...
                                                        <asp:BoundField HeaderText="Released" 
                                                            HeaderStyle-CssClass="visible-lg hidden-sm hidden-xs hidden-md" 
                                                            ItemStyle-CssClass="visible-lg hidden-sm hidden-xs hidden-md" 
                                                            DataField="que_released">
                                                        <HeaderStyle CssClass="visible-lg hidden-sm hidden-xs hidden-md" Width="20"/>
                                                        <ItemStyle CssClass="visible-lg hidden-sm hidden-xs hidden-md" Width="20"/>
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField HeaderText="Producto" 
                                                            HeaderStyle-CssClass="visible-lg hidden-sm hidden-xs hidden-md" 
                                                            ItemStyle-CssClass="visible-lg hidden-sm hidden-xs hidden-md" 
                                                            DataField="producto" ItemStyle-Width="50">
                                                        <HeaderStyle CssClass="visible-lg hidden-sm hidden-xs hidden-md" Width="50"/>
                                                        <ItemStyle CssClass="visible-lg hidden-sm hidden-xs hidden-md" Width="50"/>
                                                        </asp:BoundField>
                                                        <asp:BoundField HeaderText="Insecto" 
                                                            HeaderStyle-CssClass="visible-lg hidden-sm hidden-xs hidden-md" 
                                                            ItemStyle-CssClass="visible-lg hidden-sm hidden-xs hidden-md" 
                                                            DataField="insecto" ItemStyle-Width="50">
                                                        <HeaderStyle CssClass="visible-lg hidden-sm hidden-xs hidden-md" Width="50"/>
                                                        <ItemStyle CssClass="visible-lg hidden-sm hidden-xs hidden-md" Width="50"/>
                                                        </asp:BoundField>
                                                        <asp:BoundField HeaderText="Costo" 
                                                            HeaderStyle-CssClass="visible-lg hidden-sm hidden-xs hidden-md" 
                                                            ItemStyle-CssClass="visible-lg hidden-sm hidden-xs hidden-md" 
                                                            DataField="costo" ItemStyle-Width="50">
                                                        <HeaderStyle CssClass="visible-lg hidden-sm hidden-xs hidden-md" Width="50"/>
                                                        <ItemStyle CssClass="visible-lg hidden-sm hidden-xs hidden-md" Width="50"/>
                                                        </asp:BoundField>
                                                        <asp:BoundField HeaderText="Accion" 
                                                                HeaderStyle-CssClass="visible-lg visible-md visible-sm visible-xs" 
                                                                ItemStyle-CssClass="visible-xs visible-md visible-lg visible-sm visible-xs" 
                                                                ItemStyle-ForeColor="Black" DataField="accion" ItemStyle-Width="30">
                                                            <HeaderStyle CssClass="visible-lg visible-md visible-sm visible-xs" Width="30" />
                                                            <ItemStyle CssClass="visible-xs visible-md visible-lg visible-sm visible-xs" Width="30"
                                                                ForeColor="White" />
                                                        </asp:BoundField>
                                                    </Columns>
                                                    <PagerSettings 
