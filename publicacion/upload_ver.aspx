<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="upload_ver.aspx.cs" Inherits="queja.upload_ver" %>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <asp:Label ID="Label5" runat="server" Text="Acción: " CssClass="cols-sm-3 label label-primary"></asp:Label>
