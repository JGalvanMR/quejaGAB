<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="efectividad.aspx.cs" Inherits="queja.efectividad" %>
                    ...
                    <div class="panel panel-body">
                        <div class="panel panel-primary">
                            <div class="panel panel-body">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="txtProducto" class="col-sm-2 control-label">Producto</label>
                                        <div class="col-sm-9">
                                            ...
                                            <asp:UpdatePanel ID="upnAccionesCorrectivas" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    ...
                                                    EmptyDataText="No hay registros para mostrar" 
                                                        EmptyDataRowStyle-HorizontalAlign="Center" ShowHeaderWhenEmpty="true" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Ver." HeaderStyle-CssClass="visible-lg visible-md hidden-sm hidden-xs" ItemStyle-CssClass="hidden-xs visible-md visible-lg hidden-sm" DataField="acc_fecha_ver" />
                                                        <asp:BoundField HeaderText="Cumpl." HeaderStyle-CssClass="visible-lg visible-md hidden-sm hidden-xs" ItemStyle-CssClass="hidden-xs visible-md visible-lg hidden-sm" DataField="acc_cumpli_ver" />
                                                        <asp:BoundField HeaderText="Comen." HeaderStyle-CssClass="visible-lg visible-md hidden-sm hidden-xs" ItemStyle-CssClass="hidden-xs visible-md visible-lg hidden-sm" DataField="acc_comen_ver" />
                                                        <asp:BoundField HeaderText="Efect." HeaderStyle-CssClass="visible-lg visible-md hidden-sm hidden-xs" ItemStyle-CssClass="hidden-xs visible-md visible-lg hidden-sm" DataField="acc_fecha_efe" />
                                                        <asp:BoundField HeaderText="Cumpl." HeaderStyle-CssClass="visible-lg visible-md hidden-sm hidden-xs" ItemStyle-CssClass="hidden-xs visible-md visible-lg hidden-sm" DataField="acc_cumpli_efe" />
                                                        <asp:BoundField HeaderText="Comen." HeaderStyle-CssClass="visible-lg visible-md hidden-sm hidden-xs" ItemStyle-CssClass="hidden-xs visible-md visible-lg hidden-sm" DataField="acc_comen_efe" />
                                                        <asp:ButtonField HeaderText="Efectividad" HeaderStyle-CssClass="visible-lg visible-md hidden-sm hidden-xs" ItemStyle-CssClass="btn btn-primary visible-xs visible-md visible-lg visible-sm" ItemStyle-ForeColor="White" Text="Efectividad" CommandName="verificar_accion"/> 
                                                    </Columns>
                                                    </asp:GridView>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
