...
namespace queja
{
    public partial class servicios : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    this.dtPlacas.Clear();
            //    this.dtPlacas = this.con.comboplacas_serv(txtFechaEmb.Text);
            //    //Response.Write(txtFechaEmb.Text);
                ...
                if (chkSinRegistro.Checked == false)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            string text15 = this.ddlArea.SelectedValue.ToString();
                            string source = this.con.guarda_servicio(dtAdd, text1, text2, text3, tipo, text4, text5, text6, text7, text8, text9, text10, upper, text12, text13, text11, text14, "0", text15);
        ...
        protected void chkSinRegistro_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (chkSinRegistro.Checked == true)
            {
                //ScriptManager.RegisterClientScriptBlock((Page)this, typeof(Page), "Queja", "alert('Entra');", true);
                this.dtPlacas.Clear();
                ...
                this.ddlTransporte.DataBind();
                this.udpPlacas.Update();
                //ScriptManager.RegisterClientScriptBlock((Page)this, typeof(Page), "Queja", "alert('Sale');", true);

                //DateTime fch = Convert.ToDateTime(txtFecha.Text);
                string[] FCH_STR = txtFecha.Text.Split('/');
                int month = Convert.ToInt32(FCH_STR[1]);
                switch (month)
                {
                    case 1:
                        txtMes.Text = "ENERO";
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            //Creacion de la tabla de las quejas registradas
            iTextSharp.text.pdf.PdfPTable table3 = crear_tabla_img();
            //table.TotalWidth = 560f
            table3.SetWidths(new float[] { 570f });
            //table2.TotalWidth = 560f;
            cb.SetFontAndSize(bfTimes2, 10);
            iTextSharp.text.Font fuente_img = new iTextSharp.text.Font(bfTimes2, 8, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK);
            table3.WriteSelectedRows(0, -1, 25, 420, cb);
            ...
            if (listItemList.Count > 0)
            {
                ...
                foreach (ListItem listItem in listItemList)
                {
                    if (i == 1)
                    {
                        ...
                        jpg_1.SetAbsolutePosition(AxisX, 150);
                        doc.Add(jpg_1);
                        AxisX = AxisX + 280;//190;
                    }
                    if (i == 2)
                    {
                        ...
                        jpg_2.SetAbsolutePosition(AxisX, 150);
                        doc.Add(jpg_2);
                        //AxisX = AxisX + 500;//230;//190;
                    }
                    if (i == 3)
                    {
                        string file_name = listItem.ToString();
                        img3 = Server.MapPath(".") + "\\fotos_serv\\" + file_name;
            ...
            if (img3 != "")
            {
                ...
                jpg = iTextSharp.text.Image.GetInstance(Server.MapPath(".") + "\\imagenes\\logo.png");//, iTextSharp.text.BaseColor.WHITE
                jpg.ScaleToFit(80f, 60f);
                jpg.Alignment = iTextSharp.text.Element.ALIGN_LEFT;
                jpg2 = iTextSharp.text.Image.GetInstance(Server.MapPath(".") + "\\imagenes\\Logo grupo U.png");//, iTextSharp.text.BaseColor.WHITE
                jpg2.ScaleToFit(80f, 60f);
                jpg2.SetAbsolutePosition(540, 720);
                jpg2.Alignment = iTextSharp.text.Element.ALIGN_RIGHT;
                doc.Add(jpg);
                ...
                //Creacion de la tabla de las quejas registradas
                iTextSharp.text.pdf.PdfPTable table4 = crear_tabla_img();
                //table.TotalWidth = 560f
                table4.SetWidths(new float[] { 570f });
                //table2.TotalWidth = 560f;
                cb.SetFontAndSize(bfTimes2, 10);
                fuente_img = new iTextSharp.text.Font(bfTimes2, 8, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK);
                table4.WriteSelectedRows(0, -1, 25, 700, cb);

                iTextSharp.text.Image jpg_3 = iTextSharp.text.Image.GetInstance(img3);//, iTextSharp.text.BaseColor.WHITE
                jpg_3.ScaleToFit(230f, 210f);
                jpg_3.SetAbsolutePosition(200, 450);
                doc.Add(jpg_3);
        ...
        public iTextSharp.text.pdf.PdfPTable crear_tabla_img()
        {
            iTextSharp.text.pdf.BaseFont bfTimes3 = iTextSharp.text.pdf.BaseFont.CreateFont(iTextSharp.text.pdf.BaseFont.HELVETICA, iTextSharp.text.pdf.BaseFont.CP1252, false);
            iTextSharp.text.Font fuente = new iTextSharp.text.Font(bfTimes3, 10, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK);
            iTextSharp.text.pdf.PdfPTable tbl = new iTextSharp.text.pdf.PdfPTable(1);
            tbl.TotalWidth = 570;
            iTextSharp.text.pdf.PdfPCell cell = new iTextSharp.text.pdf.PdfPCell(new iTextSharp.text.Phrase("Imágenes", fuente));
            //cell.Colspan = 6;
            cell.HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER;
            tbl.AddCell(cell);
