<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="serviciosnew.aspx.cs" Inherits="queja.serviciosnew" %>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:DropDownList runat="server" ID="ddlTransporte" CssClass="form-control" 
                                                                        AutoPostBack="True" OnSelectedIndexChanged="ddlTransporte_SelectedIndexChanged" >
                                                                    </asp:DropDownList>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:UpdatePanel ID="upnArea" runat="server" UpdateMode="Conditional">
                                                                        <ContentTemplate>
                                                                            <asp:DropDownList runat="server" ID="ddlArea" CssClass="form-control" Enabled="false">
