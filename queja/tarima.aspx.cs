...
namespace queja
{
    public partial class tarima : System.Web.UI.Page
    {
        ...
        protected void btnBuscaOrden_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!(this.con.actualizar_tarima(this.lblQueja.Text, this.prov, this.rcho, this.tbla, this.lote, this.cadu, this.tari) == "1"))
                    return;
                this.ClientScript.RegisterStartupScript(this.GetType(), "popup", "updateParent();", true);
            }
        }
    }
}