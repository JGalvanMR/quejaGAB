<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="upload.aspx.cs" Inherits="queja.upload" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function advertencia_img1() {
        alert("El tamaño de la imagen 1 es superior a 4Mb favor de verificarlo");
        }
        function advertencia_img2() {
        alert("El tamaño de la imagen 2 es superior a 4Mb favor de verificarlo");
        }
        function advertencia_img3() {
        alert("El tamaño de la imagen 3 es superior a 4Mb favor de verificarlo");
        }
        function advertencia_file1() {
        alert("El elemento 1 no es una imagen o un archivo PDF");
        }
        function advertencia_file2() {
        alert("El elemento 2 no es una imagen o un archivo PDF");
        }
        function advertencia_file3() {
        alert("El elemento 3 no es una imagen o un archivo PDF");
        }*/
    </script>
    <style type="text/css">
    body
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 col-xs-12">
                                            <asp:Button ID="btnSubir" runat="server" Text="Subir imagenes" 
                                                CssClass="btn btn-primary col-sm-12 col-xs-12" ValidationGroup="grupo1" 
