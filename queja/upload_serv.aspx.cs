...
namespace queja
{
    public partial class upload_serv : System.Web.UI.Page
    {
              ...
              "pdf"
                ...
                if (this.img1.HasFile)
                {
                    if (this.img1.FileName.Contains(".pdf"))
                        ...
                        upload_ver.ScaleImage((System.Drawing.Image)new Bitmap(this.img1.PostedFile.InputStream), 405).Save(str1 + "1_" + this.lblQueja.Text + ".jpg", ImageFormat.Jpeg);
                }
                if (this.img2.HasFile)
                {
                    if (this.img2.FileName.Contains(".pdf"))
                        ...
                        upload_ver.ScaleImage((System.Drawing.Image)new Bitmap(this.img2.PostedFile.InputStream), 405).Save(str1 + "2_" + this.lblQueja.Text + ".jpg", ImageFormat.Jpeg);
                }
                if (this.img3.HasFile)
                {
                    if (this.img3.FileName.Contains(".pdf"))
                        ...
                        upload_ver.ScaleImage((System.Drawing.Image)new Bitmap(this.img3.PostedFile.InputStream), 405).Save(str1 + "3_" + this.lblQueja.Text + ".jpg", ImageFormat.Jpeg);
                }
