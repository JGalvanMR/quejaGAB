...
namespace queja
{
    public partial class verificacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.dtArchivos.Columns.Add("nombre", typeof(string));
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                this.txtFecha.Text = Convert.ToDateTime(this.fecha_reg).ToShortDateString();
            ...
            this.img1.ImageUrl = "fotos_ant/1_" + this.lblQueja.Text + ".jpg";
            this.img2.ImageUrl = "fotos_ant/2_" + this.lblQueja.Text + ".jpg";
            this.img3.ImageUrl = "fotos_ant/3_" + this.lblQueja.Text + ".jpg";
            this.Image1.ImageUrl = "fotos_ant/1_" + this.lblQueja.Text + ".jpg";
        ...
        protected void gvwRespAcciones_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            this.dtAccion_Correctivas = this.con.verificacion_acciones_correctivas(folio, resp);
        ...
        protected void gvwAccionesCorrectivas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            string str3 = this.Server.HtmlDecode(row.Cells[3].Text).Trim();
            string str4 = this.Server.HtmlDecode(row.Cells[4].Text);
            string str5 = this.Server.HtmlDecode(row.Cells[5].Text);
            ...
            string f_1 = DateTime.Now.ToShortDateString();
            this.txtFechaVer.Text = Convert.ToDateTime(f_1).ToString("dd/MM/yyyy");
            ...
            if (str3 != "")
            {
                ...
                this.uplImagenes.Update();
                this.Image4.ImageUrl = "fotos_des/1_" + this.lblQueja.Text + "_" + this.lblAccionCorrectiva.Text + ".jpg";
                this.Image5.ImageUrl = "fotos_des/2_" + this.lblQueja.Text + "_" + this.lblAccionCorrectiva.Text + ".jpg";
                this.Image6.ImageUrl = "fotos_des/3_" + this.lblQueja.Text + "_" + this.lblAccionCorrectiva.Text + ".jpg";
                this.upnFotosDes.Update();
        ...
        {
            if (this.con.insertaverificacion(this.lblAccionCorrectiva.Text, this.txtFechaVer.Text, this.ddlCumplimiento.SelectedValue.ToString().ToUpper(), this.txtComentario.Text.ToUpper()) == "1")
            {
                this.lblSuccess.Visible = true;
                this.dtAccion_Correctivas = this.con.verificacion_acciones_correctivas(this.lblFolioRespAcc.Text, this.lblClaveRespAcc.Text);
                this.gvwAccionesCorrectivas.DataSource = (object)this.dtAccion_Correctivas;
                this.gvwAccionesCorrectivas.DataBind();
                this.upnAccionesCorrectivas.Update();
                ...
                this.btnImagenes.Enabled = true;
                this.UpdatePanel1.Update();
                this.con.etapa_verificar(this.lblQueja.Text);
        ...
        protected void btnImagenes_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript((Page)this, typeof(string), "New_Window", "window.open('upload_ver.aspx', null, 'height=600,width=800,status=no,toolbar=no,menubar=no,location=no' );", true);
        }
